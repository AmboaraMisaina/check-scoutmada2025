                            ...
                            <tr style="border-bottom:1px solid #e1e5e9;">
                                ...
                                <?php if ($_SESSION['role'] == 'admin') { ?>
                                    <td>
                                        ...
                                        <button type="button" class="btn btn-warning" onclick="if(confirm('Supprimer ce participant ?')) window.location.href='participants.php?kit=<?= $p['id']; ?>'">👕</button>
                                    </td>
                                ...
                                <?php } if ($_SESSION['role'] == 'kit') {
                                    ?>
                                    <td>
                                        <button type="button" class="btn btn-primary" onclick="if(confirm('Supprimer ce participant ?')) window.location.href='participants.php?kit=<?= $p['id']; ?>'">👕</button>
                                    </td>
                                    <?php
                                } ?>
                            </tr>
