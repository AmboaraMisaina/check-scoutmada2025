...
<div id="qr-reader" style="width:300px; margin:auto; margin-top:2rem;"></div>
...
<div id="successModal" style="display:none; position:fixed; top:0; left:0; width:100vw; height:100vh; background:rgba(0,0,0,0.4); z-index:9999; align-items:center; justify-content:center;">
    <div style="background:white; padding:2rem 3rem; border-radius:10px; box-shadow:0 4px 16px rgba(0,0,0,0.2); text-align:center;">
...
<div id="errorModal" style="display:none; position:fixed; top:0; left:0; width:100vw; height:100vh; background:rgba(0,0,0,0.4); z-index:9999; align-items:center; justify-content:center;">
    <div style="background:white; padding:2rem 3rem; border-radius:10px; box-shadow:0 4px 16px rgba(0,0,0,0.2); text-align:center;">
        ...
        <button onclick="closeErrorModal()" style="margin-top:1rem; padding:0.5rem 1rem; border:none; border-radius:5px; background:#e74c3c; color:white; cursor:pointer;">Fermer</button>
    </div>
</div>
